...
- 用于订阅PolarDB-X Binlog: [flink-sql-connector-mysql-cdc-2.3.0.jq.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-mysql-cdc/2.3.0.jq/flink-sql-connector-mysql-cdc-2.3.0.jq.jar)
