...
2. Download following JAR package required and put them under `flink-1.16.0/lib/`:
   ...
   **Download links are available only for stable releases, SNAPSHOT dependency need build by yourself. **
    ...
    - [flink-sql-connector-postgres-cdc-2.3.0.jq.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-postgres-cdc/2.3.0.jq/flink-sql-connector-postgres-cdc-2.3.0.jq.jar)
